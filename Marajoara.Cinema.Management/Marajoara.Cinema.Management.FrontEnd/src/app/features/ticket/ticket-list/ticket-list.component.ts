...
export class TicketListComponent implements OnInit {
  ...
  openDeleteDialog() {
    return this.dialog.open(ConfirmDialogComponent, {
      data: {
        ...
        message: `Deseja mesmo excluir Ticket com código ${this.selectedTicket.code}?`,
        confirmText: 'Excluir',
      },
    });
  }
  ...
  openUseTicketDialog() {
    return this.dialog.open(ConfirmDialogComponent, {
      data: {
        title: 'Usar Ticket',
        message: `Deseja mesmo marcar como usuado o Ticket com código ${this.selectedTicket.code}? (Essa ação não poderá ser desfeita)`,
